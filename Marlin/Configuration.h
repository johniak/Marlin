...
#define STRING_CONFIG_H_AUTHOR "(Jan Romaniak, Anet config)" // Who made the changes.
 ...
 *
 */
// #define Z_MIN_PROBE_PIN P20 // Pin 32 is the RAMPS default
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 2, -71.70 , -2.2 }
